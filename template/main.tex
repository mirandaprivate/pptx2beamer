...
\author{丛明舒}
\title{SWIFT Beamer Theme}
\subtitle{毕业设计开题报告}
\institute{深大微众金融科技学院}
\date{\,}
\usepackage{szu_blue}
...
\definecolor{deepblue}{rgb}{0.0898,0.1875,0.3672}
\definecolor{deepred}{rgb}{0.6,0,0}
\definecolor{deepgreen}{rgb}{0,0.5,0}
\definecolor{halfgray}{gray}{0.55}
\definecolor{szured}{rgb}{0.523,0.125,0.254}

\lstset{
    basicstyle=\ttfamily\small,
    keywordstyle=\bfseries\color{deepblue},
    emphstyle=\ttfamily\color{szured},    % Custom highlighting style
...
\begin{frame}
    ...
    \begin{figure}[htpb]
        \begin{center}
            \includegraphics[width=0.618\linewidth]{pic/szu_logo.png}
        \end{center}
    \end{figure}
\end{frame}

% \begin{frame}   \tableofcontents[sectionstyle=show,subsectionstyle=show/shaded/hide,subsubsectionstyle=show/shaded/hide]
% \end{frame}
...
\begin{frame}{作图}
    ...
    \begin{figure}[htpb]
        \centering
        \includegraphics[width=0.2\linewidth]{pic/szu_logo.png}
        \caption{这个校徽就是矢量图}
    \end{figure}
\end{frame}
...
\begin{frame}
    \begin{center}
        \textcolor{szured}{\Huge\calligra Thanks!}
    \end{center}
\end{frame}
